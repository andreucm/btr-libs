...
void CpointTracker::setParameters(pointTrackerParams & prms)
{
      //get params
      ...
      switch(params.featureType)
      {
            ...
            case BRISK_FEATURES:
                        ...
                        break;      
            default:
                  std::cout << __LINE__ << ": WARNING: CpointTracker::CfeatureTracker(): Unknown feature type: " << params.featureType << ". No detector cerated" << std::endl;
                  break;                  
      }
...
void CpointTracker::setDefaultParameters()
{
...
void CpointTracker::getDisplayImage(cv::Mat & img)
{
...
void CpointTracker::findCorrespondences()
{
	...
	{
		if (params.verbose) std::cout << __LINE__ << ": CpointTracker::findCorrespondences(): Unable to find correspondences. Empty set !" << std::endl;
		return;
	}
...
bool CpointTracker::buildOutputImage()
{
      ...
      switch(params.viewMode)
      {
            ...
            default:
                  std::cout << __LINE__ << ": CpointTracker::displayOutput(). Unknown View mode. viewMode: " << params.viewMode << std::endl;
                  break;            
      }      
...
void CpointTracker::displayOutputImage()
{
...
void CpointTracker::saveOutputImage(std::string folderName)
{
...
void CpointTracker::printConfig() const
{
