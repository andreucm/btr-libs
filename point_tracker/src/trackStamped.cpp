...
void CtrackStamped::clear()
{
	track.clear();
}

void CtrackStamped::setId(const unsigned int tId)
{
	id = tId;
}
...
unsigned int CtrackStamped::getTrackSize() const
{
	return this->track.size();
}

cv::Point2f & CtrackStamped::getPoint(const unsigned int ii)
{
...
cv::Scalar_<uchar> & CtrackStamped::getVizColor()
{
	return vizColor; //cv::Scalar(this->vizColor[0],this->vizColor[1],this->vizColor[2]);
}

int CtrackStamped::getIndexOfClosestPoint(const double tt, const double maxDt, const int ii0) const
{
        int ii, ii1;
        double dT, dTmin;
...
int CtrackStamped::getCorrespondence(const double t1, const double t2, const double maxDt, correspondencePair & pair) const
{
	unsigned int ii;
	int ii1,ii2;
...
int CtrackStamped::getCorrespondenceInterpolated(const double t1, const double t2, correspondencePair & pair) const
{
        unsigned int ii;
        int ii1,ii2;
        double a1,a2;
...
double CtrackStamped::getLastTs() const
{
        return time.back();
}

bool CtrackStamped::isLastPoint(const cv::Point2f & pt) const
{
...
int CtrackStamped::getTrackVelocity(const double t1, const double t2, const double maxDt, cv::Point2f & pxV) const
{
